...
\begin{enumerate}
  ...
  \item $\mu_{\alpha}=2$, $X_{i,t}\sim \Gamma(1,2)$, $\delta_i, \gamma_i \sim \normal{1}{0.5}$
  \item $\sigma=10$ for the base case.
  \item $\sigma_{\alpha}= (5, 10, 25, 50, 100)$
  \item $\sigma= (5, 10, 25, 50, 100)$
\end{enumerate}
