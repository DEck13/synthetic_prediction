...
For the use of our methodology, caution should be dedicated to the construction of donor pool. Otherwise, the result will not be robust to the noises introduced by the the ones that are not similar to the time series of interest. 
