...
\response{Thank you for the opportunity to submit a revision. We include a point by point response for the comments and concerns raised by the reviewers.}
...
\begin{align*}
 ...
 & \alpha_i = \mu_{\alpha} +\delta_i'\mathbf{x}_{i, T_i^*+1} + \tilde{\varepsilon}_i\quad  \text{independent under } \mathcal{M}_{21} \text{ or } \mathcal{M}_{22}.
\end{align*}
