...
\textcolor{red}{In this section, we discuss two data examples of post-shock prediction. Section \ref{forecasting} discusses the prediction of Conoco Phillips stock under the unprecedented oil supply shock and financial crisis shock. Section \ref{apple} applies our proposed method to forecasting Apple stock price with precedented shock source from releasing MacBook series product. They provide empirical illustration for real-life applications with precedented shocks and unprecedented ones, respectively. The adjusted forecast in Section \ref{forecasting} performs much better than original forecast whereas the adjusted forecast in Section \ref{apple} nearly perfectly recovers the response after shock. The reasons are detailed in  Section \ref{forecasting} and Section \ref{apple}, respectively.}
