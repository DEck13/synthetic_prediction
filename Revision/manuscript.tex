...
\begin{figure*}[t!]
  \begin{center}
    ...
    \caption{March 9th, 2020 post-shock forecasts for Conoco Phillips stock price. \textcolor{red}{Black dots and magenta line represent real data and fitted line, respectively.}}
    \label{Fig:CP}
  \end{center}  
  \vspace{-.6cm}
\end{figure*}
