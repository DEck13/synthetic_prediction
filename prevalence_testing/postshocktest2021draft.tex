...
\begin{table}[H]
	\caption{Results for Conoco Philips ($n=3$), $\mbf{W}^* = (0.221, 0, 0.779)$ from scaled covariates}
\begin{center}
  \begin{tabular}{cccccccccr}
     $L$ ($T_i-T^*_i$) & Model & $p_1$ &  $|\hat{p}-p_1|$ & Vote & weighted Vote  & weighted  AIC\\
     \hline 
     7 & Permanent & 1  & 0 & \textcolor{red}{0}  & \textcolor{red}{0} & $289.61$ \\      7 & Dynamic & 1 & $0$   &  \textcolor{red}{0} & \textcolor{red}{0}  & 420.86 \\[.2cm]
     15 & Permanent & 1   & 0 & \textcolor{red}{0} &  \textcolor{red}{0}    & 294.74 \\
     15 & Dynamic & 1 & 0 & \textcolor{red}{0}  & \textcolor{red}{0}  & $416.12$\\[.2cm]
     30 & Permanent & 1   & $0$ &  \textcolor{red}{0} & \textcolor{red}{0}  &  303.88 \\
     30 & Dynamic & 1  & 0 & \textcolor{red}{0} &\textcolor{red}{0}  & 435.22
  \end{tabular}
\end{center}	
\end{table}
