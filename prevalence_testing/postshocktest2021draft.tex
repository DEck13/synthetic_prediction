...
$\mathcal{F}_k(\x_{i,T_i^*})$ and $\mathcal{F}_{\lambda}(\x_{i,T_i^*})$ needs to be small relative to the signal captured in $\x_{i,T_i^*}$, and $\sigma^2_\alpha$ and $\Sigma^2_\gamma$ needs to be small relative to $\mu_\alpha +\delta_i'\x_{i,T_i^*}$ and $\beta_o + \beta\mbf{x}_{i,T_i^*+1}$ respectively. 
