...
\begin{table}[H]
	\caption{Results for Conoco Philips dual shock ($n=2$), $\mbf{W}^* = (0.756, 0.244)$ from scaled covariates} \label{coptable}
\begin{center}
  \begin{tabular}{cccccccccr}
     $H$   &  $\hat{p}_1$ &   Vote (Correct?) & weighted Vote (Correct?)   \\
     \hline 
     2  & 1    & 0 (Yes) &0 (Yes)   \\ 
     4  & 1 & 0(Yes)  &0 (Yes)  \\ 
     6   & 1  &0 (Yes) & 0 (Yes) \\ 
