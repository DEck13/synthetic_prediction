...
\begin{center}
  \begin{tabular}{cccccccccr}
     $H$  & Model &   $p_1$ & $\hat{p}_1$ & $|\hat{p}_1-p_1|$ & Vote (Correct?) & weighted Vote (Correct?)   \\
     \hline 
     \multirow{2}{*}{2} & $\mc{M}_0$  &   0.300 & 0.443  & 0.143 & 0 (Yes) & 0 (Yes)\\      
      & $\mc{M}$  & 0.775 & 0.591 & $0.184$   & 0 (Yes) &0 (Yes)   \\[.2cm]
     \multirow{2}{*}{3} & $\mc{M}_0$ &   0.215 & 0.477 & $0.262$ & 0 (Yes) & 0 (Yes)    \\
      &  $\mc{M}$ & 0.740 & 0.600 & 0.140 & 0 (Yes) & 0 (Yes)  \\[.2cm]
     \multirow{2}{*}{4} &  $\mc{M}_0$ &   0.615   & $0.343$ & 0.272 & 0 (Yes) & 0 (Yes)  \\
      &  $\mc{M}$ & 0.780 & 0.464  & 0.316 & 0 (Yes) & 0 (Yes) \\[.2cm]
     \multirow{2}{*}{5} & $\mc{M}_0$ & 0.030 & 0.377 & 0.347 & 0 (No) & 0 (No)\\
     & $\mc{M}$ & 0.940 & 0.293 & 0.647 & 0 (Yes) & 0 (Yes)
  \end{tabular}
\end{center}	
\end{table}
