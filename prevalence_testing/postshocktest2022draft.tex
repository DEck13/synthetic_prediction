...
\vspace*{0.5cm}\noindent\textcolor{red}{Jilei, explain how the h-ahead forecasts are computed here}
...
We now motivate a voting method based on the p-values computed in the donor pool.
\textcolor{red}{Jilei, you need to explain what the voting method is, possibly in algorithmic format.}
...
\begin{center}
  \begin{tabular}{cccccccccr}
     ...
     15 & $\mc{M}_0$ & \multirow{2}{*}{$0.817$}  & 1   & $0.82$ & 0 (Yes) &1 (No)    \\
     15 &  $\mc{M}$ & & 1 & 0 &0 (Yes)  &0 (Yes)  \\[.2cm]
     30 &  $\mc{M}_0$ & \multirow{2}{*}{$1$}  & 1   & $0.82$ & 0 (Yes) &1 (No)   \\
...
\begin{center}
  \begin{tabular}{ccccccccr}
     ...
     \hline 
     $\mc{M}_0$  & \multirow{2}{*}{0.722}& 0  & 1 & 1 (No) &1 (No)  \\      
